try:
    from axon_reconstructor.internal.generate_templates.extract_templates import *
except Exception:  # pragma: no cover
    # Keep this module importable in minimal dev/test envs.
    # Functions that depend on extract-time tooling will fail when called.
    pass
