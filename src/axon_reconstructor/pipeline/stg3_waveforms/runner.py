...
def extract_waveforms(
    *,
    ...
    Produces:
      ...
      <well>/stg3_waveforms_outputs/segment_waveforms/ (optional)
            <well>/stg3_waveforms_outputs/grids/uncurated.pdf
            <well>/stg3_waveforms_outputs/grids/curated.pdf (if curation succeeds)
            <well>/stg3_waveforms_outputs/grids/segments/<seg_name>/curated_best_local.pdf (per segment)
            <well>/stg3_waveforms_outputs/panels/<name>/unit_<id>.svg (per unit)
