...
Under `<well>/stg3_waveforms_outputs/`:
...
- Curation (consumed)
  - Uses spikesorting-stage quality metrics from `<well>/stg2_spikesorting_outputs/qm_unfiltered.xlsx` to decide curated vs rejected units.
