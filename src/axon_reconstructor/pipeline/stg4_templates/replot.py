...
- merged templates: <well>/stg4_templates_outputs/templates/merged/unit_<id>/...
- full templates (optional): <well>/stg4_templates_outputs/templates/full/unit_<id>/...

Legacy (pre-refactor) paths are supported for reading:
- <well>/stg4_templates_outputs/merged_units/
...
def _load_all_recorded_electrode_ids(*, full_channels_templates_dir: Path):
    ...
    This is used to distinguish:
      ...
      - non-contributing electrodes: present in recording but not contributing for this unit
        ...
        Source:
            <well>/stg4_templates_outputs/templates/full/all_recorded_electrode_ids.npy
    """
...
def _load_plot_window_from_waveforms_outputs(*, well_out_dir: Path) -> tuple[float, Optional[float], Optional[float]]:
    ...
    params_json = well_out_dir / "stg3_waveforms_outputs" / "waveform_extraction_params.json"
...
def _parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        action="store_true",
        help="Rebuild stg4_templates_outputs/templates/full from merged templates using Maxwell full-chip electrode ids (fixes sparse full templates for topo plots).",
    )
