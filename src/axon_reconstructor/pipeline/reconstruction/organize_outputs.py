...
Example:
    python -m axon_reconstructor.pipeline.reconstruction.organize_outputs \
        --unit-dir /path/to/<well>/reconstruction_outputs/by_unit/unit_119
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--unit-dir", type=Path, required=True, help="Path to .../reconstruction_outputs/by_unit/unit_<id>")
    return p.parse_args()
