...
This package is a refactor of the original monolithic preprocessing module
with canonical ownership under `axon_reconstructor.pipeline.stg1_preprocessing`.
