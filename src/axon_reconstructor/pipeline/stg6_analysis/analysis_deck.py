...
------
Writes to:
  <well_out_dir>/stg6_analysis_outputs/unit_summary_grids_complete.pptx
...
def run_with_args(args: object) -> int:
    ...
    def required_sources(uid: int) -> list[Path]:
        ...
        return [
            well_out_dir / "stg4_templates_outputs" / "footprints" / "3D" / f"unit_{uid}.png",
            well_out_dir / "stg4_templates_outputs" / "propagation_plots" / f"unit_{uid}.png",
            well_out_dir
            ...
            well_out_dir / "stg5_reconstruction_outputs" / "by_unit" / f"unit_{uid}" / "heuristics" / "graph_heuristics.png",
        ]
    ...
    def _add_all_units_morphology_slide(*, prs: any, stream_id: str, well_out_dir: Path, blank_layout: any) -> None:
        ...
        recon_dir = Path(well_out_dir) / "stg5_reconstruction_outputs"
        ...
        if png_path.exists():
            ...
            tmp_png = Path(well_out_dir) / "stg6_analysis_outputs" / "_all_units_morphology.png"
    ...
    try:
        ...
        # Slide 2: all-units morphology from stg5_reconstruction_outputs.
        ...
        for uid, png_path in eligible:
            ...
            recon_unit_dir = out.well_out_dir / "stg5_reconstruction_outputs" / "by_unit" / f"unit_{uid}"
