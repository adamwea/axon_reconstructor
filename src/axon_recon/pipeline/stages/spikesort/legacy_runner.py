...
from axon_recon.pipeline.checkpointing import ProcessingStage as AxonProcessingStage, load_checkpoint
from axon_recon.pipeline.pipeline_logging import log_stage_complete, log_stage_failure, log_stage_start
from axon_recon.pipeline.checkpointing import compute_stage_checkpoint_file, save_stage_completed, save_stage_failed, save_stage_started
from axon_recon.pipeline.stages.preprocess.constants import LEGACY_PREPROCESS_OUTPUTS_DIRNAME, PREPROCESS_OUTPUTS_DIRNAME
...
def run_spikesorting_stage(*, inputs: SpikeSortingInputs, logger: logging.Logger) -> SpikeSortingOutputs:
    ...
    # Reuse axon_recon's MEA_Analysis-style output path computation.
