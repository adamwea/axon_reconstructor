...
from ..runner import run_spikesort_plot_concat_traces_stage
...
def run_spikesort_plot_concat_traces(
	*,
	...
	return run_spikesort_plot_concat_traces_stage(
		h5_path=h5_path,
		stream_id=stream_id,
...
def run_spikesort_plot_concat_traces_from_runtime(
	*,
	...
	from ....runner import run_spikesort_plot_concat_traces_from_runtime as run_runtime
