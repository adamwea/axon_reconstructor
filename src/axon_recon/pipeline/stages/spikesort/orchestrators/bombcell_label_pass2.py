...
from ..runner import run_spikesort_bombcell_label_pass2_stage
from .sort import _target_datasets_override_from_args


def run_spikesort_bombcell_label_pass2(
	*,
	h5_path: Path,
	stream_id: str,
	...
	return run_spikesort_bombcell_label_pass2_stage(
		h5_path=h5_path,
		stream_id=stream_id,
...
def run_spikesort_bombcell_label_pass2_from_runtime(
	*,
	...
	from ....runner import (
		run_spikesort_bombcell_label_pass2_from_runtime as run_pass2_runtime,
	)

	return run_pass2_runtime(
...
def _print_spikesort_bombcell_pass2_aggregate(agg: object) -> int:
...
def _run_bombcell_label_pass2_from_args(args: argparse.Namespace) -> int:
	target_datasets_override = _target_datasets_override_from_args(args)
	return _print_spikesort_bombcell_pass2_aggregate(
		run_spikesort_bombcell_label_pass2_from_runtime(
