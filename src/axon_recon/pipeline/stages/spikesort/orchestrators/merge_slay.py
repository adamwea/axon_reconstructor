	...
	*,
	...
	return run_spikesort_merge_stage(
		...
		stage_config=_with_standalone_merge_phase_stage_config(
			...
			assert_field="cache_sorting_outputs_before_merge_assert_slay_uses_canonical_workspace",
		),
...
def run_spikesort_merge_slay_from_runtime(
	*,
	config_path: str,
