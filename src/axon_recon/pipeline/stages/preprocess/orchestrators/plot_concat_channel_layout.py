...
_PHASE_NAME = "plot_concat_channel_layout"


def run_preprocess_plot_concat_channel_layout(inputs: PreprocessInputs) -> dict[str, object]:
...
def _run_plot_concat_channel_layout_from_args(args: argparse.Namespace) -> int:
	return run_preprocess_phase_from_args(args, runtime_runner=run_preprocess_plot_concat_channel_layout_from_runtime)