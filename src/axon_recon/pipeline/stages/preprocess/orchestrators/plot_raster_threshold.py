...
_PHASE_NAME = "plot_raster_threshold"


def run_preprocess_plot_raster_threshold(inputs: PreprocessInputs) -> dict[str, object]:
...
def _run_plot_raster_threshold_from_args(args: argparse.Namespace) -> int:
	return run_preprocess_phase_from_args(args, runtime_runner=run_preprocess_plot_raster_threshold_from_runtime)