...
_PHASE_NAME = "prepare_raw_binaries"


def run_preprocess_prepare_raw_binaries(inputs: PreprocessInputs) -> dict[str, object]:
...
def _run_prepare_raw_binaries_from_args(args: argparse.Namespace) -> int:
	return run_preprocess_phase_from_args(args, runtime_runner=run_preprocess_prepare_raw_binaries_from_runtime)