...
def run_report_recons_phase(
	*,
	...
	if bool(phase_cfg.av_recons.write_pdf):
		raise NotImplementedError(
			"reconstruct.report_recons av_recons.write_pdf is not implemented yet; disable it for now"
		)
	...
	if write_circle_grid and not preserve_stage_reports:
		report_paths = resolve_report_output_paths_fn(reconstruction_out_dir=reconstruction_out_dir, reports=inputs.reports)
		circle_entries = [
