...
def _run_reconstruct_report_recon_grid_phase_impl(
    *,
    ...
    return reconstruct_runner.run_report_recon_grid_core_phase(
        inputs=inputs,
        reconstruction_out_dir=env.reconstruction_out_dir,
        ...
        render_footprint_map_grid_from_assets_fn=reconstruct_runner.render_footprint_map_grid_from_assets,
        finalize_grid_svg_output_fn=reconstruct_runner.finalize_grid_svg_output,
