...
def run_reconstruct_plot_branch_propagations_phase(inputs: ReconstructionInputs) -> dict[str, Any]:
    ...
    unit_results, failed_units_summary_json = _run_reconstruct_plot_branch_propagations_phase_impl(
...
def _run_reconstruct_plot_branch_propagations_phase_impl(
    *,
    ...
    unit_results = reconstruct_runner.run_plot_branch_propagations_core_phase(
        inputs=inputs,
        reconstruction_out_dir=env.reconstruction_out_dir,
        ...
        write_unit_branch_propagation_plot_fn=reconstruct_runner.write_unit_branch_propagation_plot,
