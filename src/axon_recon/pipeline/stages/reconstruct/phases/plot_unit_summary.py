    ...
    with with_checkpoint_marker(
        ...
        if get_no_plot_override() is True:
            return reconstruct_runner.reconstruct_phase_plots_disabled_skip(
                inputs=inputs, phase_name="plot_unit_summary", summary_json=summary_json
            )
        unit_results, failed_units_summary_json = _run_reconstruct_plot_unit_summary_phase_impl(
...
def _run_reconstruct_plot_unit_summary_phase_impl(
    *,
    ...
    unit_results = reconstruct_runner.run_plot_unit_summary_core_phase(
        inputs=inputs,
        reconstruction_out_dir=env.reconstruction_out_dir,
        ...
        write_unit_summary_plot_fn=reconstruct_runner.write_unit_summary_plot,
        ...
        resolve_unit_summary_phase_output_paths_fn=reconstruct_runner.resolve_unit_summary_phase_output_paths,
