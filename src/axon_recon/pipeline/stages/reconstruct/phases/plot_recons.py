...
def _run_reconstruct_plot_recons_phase_impl(
    *,
    ...
    unit_results = reconstruct_runner.run_plot_recons_core_phase(
        inputs=inputs,
        reconstruction_out_dir=env.reconstruction_out_dir,
        ...
        write_unit_amplitude_map_png_fn=reconstruct_runner.write_unit_amplitude_map_png,
        write_unit_circle_recon_plot_fn=reconstruct_runner.write_unit_circle_recon_plot,
