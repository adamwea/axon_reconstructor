...
STAGE_PHASES: dict[str, tuple[tuple[str, tuple[str, ...]], ...]] = {
	...
	"spikesort": (
		("concat_binary", ("spikesort_outputs", "cache", "concat_binary", "concat_binary_summary.json")),
		("plot_concat_traces", ("spikesort_outputs", "cache", "concat_binary", "plot_concat_traces_summary.json")),
		("plot_concat_channel_layout", ("spikesort_outputs", "cache", "concat_binary", "plot_concat_channel_layout_summary.json")),
