...
from debug_env import load_env_file_into_os
...
def extract_metrics_for_well(
    *,
    ...
    by_unit_dir = well_dir / "reconstruction_outputs" / "by_unit"
...
def main() -> None:
    ...
    ap.add_argument(
        "--config",
        type=Path,
        default=Path(__file__).resolve().parent / "cross_well_config.yml",
