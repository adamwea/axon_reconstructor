...
if __name__ == "__main__":
    # NERSC Debug: 
    # 1. salloc --nodes 1 --qos interactive --time 02:00:00 --constraint gpu --gpus 1 --account m2043_g
    # 2. shifter --image adammwea/axonkilo_docker:v7 /bin/bash
    # Specify arguments for testing
    # sys.argv = [
    #     'run_pipeline_HPC.py',  # Script name
    #     '--plate_file', 
    #     '/pscratch/sd/a/adammwea/xRBS_input_data/B6J_DensityTest_10012024_AR/241004/M08029/AxonTracking/000007/data.raw.h5',
    #     '--output_dir', 
