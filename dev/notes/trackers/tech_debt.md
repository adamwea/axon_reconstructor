...
- **Status**: in-progress (slice 14c approach A — target-level skip — landed for **preprocess** `ee2ec7c`, **analysis** `2093977`, **reconstruct** `847e197`; **spikesort** is the lone remaining stage)
